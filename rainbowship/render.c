...
int point_offscreen (SDL_Surface *fb, int x, int y)
{
    return (x > fb->w
            || x < 0
            || y > fb->h
...
void fill_buffer(SDL_Surface *dest, SDL_Surface *src)
{
...
void clear_buffer(SDL_Surface *fb)
{
...
void draw_pixel (int x, int y, SDL_Surface *fb, void* value)
{
